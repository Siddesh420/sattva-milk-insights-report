...
const Footer = () => {
  return (
    <footer className="bg-earth-800 dark:bg-earth-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-cream-200 dark:text-cream-300">सत्य दूध</p>
              </div>
            </div>
            <p className="text-cream-200 dark:text-cream-300 text-sm">
              Pure, honest dairy from our heart to yours. 
              Experience the authentic taste of traditional farming.
            </p>
            <div className="flex space-x-3">
              <Facebook className="h-5 w-5 text-cream-300 dark:text-cream-400 hover:text-white cursor-pointer" />
              <Instagram className="h-5 w-5 text-cream-300 dark:text-cream-400 hover:text-white cursor-pointer" />
              <Twitter className="h-5 w-5 text-cream-300 dark:text-cream-400 hover:text-white cursor-pointer" />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-cream-200 dark:text-cream-300 text-sm">
        ...
        {/* Bottom Section */}
        <div className="border-t border-earth-700 dark:border-earth-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4 text-cream-200 dark:text-cream-300 text-sm">
            ...
            <div className="flex items-center space-x-2 text-cream-200 dark:text-cream-300 text-sm">
