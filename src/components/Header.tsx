      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#home" className="text-earth-700 hover:text-terracotta-600 transition-colors font-medium">Home</a>
            <a href="#products" className="text-earth-700 hover:text-terracotta-600 transition-colors font-medium">Products</a>
            <a href="#story" className="text-earth-700 hover:text-terracotta-600 transition-colors font-medium">Our Story</a>
            <a href="#traceability" className="text-earth-700 hover:text-terracotta-600 transition-colors font-medium">Traceability</a>
            <a href="#contact" className="text-earth-700 hover:text-terracotta-600 transition-colors font-medium">Contact</a>
          </nav>
